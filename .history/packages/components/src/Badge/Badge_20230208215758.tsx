...
const Badge: React.FC<BadgeProps> = (props: BadgeProps) => {
  ...
  if (children) {
    ...
    return (
      <div style={style}>
        <div
          className={classNames('text-white box-border border transition focus:outline-none', sizeStyle[size ?? 'default'], className)}
          style={{
            right: countRight(),
            top: countTop(),
            backgroundColor: color,
