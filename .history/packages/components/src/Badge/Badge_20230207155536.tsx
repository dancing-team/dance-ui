...
const Badge = React.forwardRef(function BadgeInner(
  { color, count, dot, offset, overflowCount, showZero, size, title, className, style, children }: BadgeProps,
  ...
  React.Children.map(children, (c, index) => {
    return React.cloneElement(
      ...
      {},
      {
        children: <div className={'son'} style={{ backgroundColor: 'red', width: '100px', height: '50px' }}></div>,
      },
    )
  })
